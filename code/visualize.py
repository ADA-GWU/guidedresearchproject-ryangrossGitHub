...
plt.plot(scale_array([item[0] for item in few_shot_vals.input], LON_MIN, LON_MAX),
         scale_array([item[1] for item in few_shot_vals.input], LAT_MIN, LAT_MAX), linestyle="solid", color="Lime")

plt.plot(scale_array([item[0] for item in few_shot_vals.actuals], LON_MIN, LON_MAX),
         scale_array([item[1] for item in few_shot_vals.actuals], LAT_MIN, LAT_MAX), linestyle="dashed", markersize=4, color="Lime")

plt.plot(scale_array([item[0] for item in few_shot_vals.pred], LON_MIN, LON_MAX),
         scale_array([item[1] for item in few_shot_vals.pred], LAT_MIN, LAT_MAX), linestyle="dashed", color="Red")
